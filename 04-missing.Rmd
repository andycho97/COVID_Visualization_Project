...
statedata2 <- select(statedata, -c("checkTimeEt", "commercialScore", "dateChecked", "dateModified", "hash", "negativeRegularScore", "negativeScore", "posNeg", "positiveScore", "score", "grade",
